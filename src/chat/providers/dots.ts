...
const BASE_URL = "https://note3-prev-api.askdiandian.com/v1";
const UPSTREAM_MODEL = "dots3-note-prev";
const ENV_KEY = "DOTS_API_KEY";

export const dots: ChatProvider = {
  id: "dots",
  ...
  async chat(req, env, signal) {
    ...
    try {
      ...
      throw new RetryableError("dots: response is not valid JSON", { cause: err });
    }
  },
};
